...
?>
<Response>
  <Dial record="true" recordingStatusCallback="<?=htmlspecialchars($callback, ENT_QUOTES)?>" recordingStatusCallbackMethod="POST" callerId="+19042175152"><?=htmlspecialchars($to, ENT_QUOTES)?></Dial>
