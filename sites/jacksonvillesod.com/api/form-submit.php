<?php
/**
 * Form Handler - jacksonvillesod.com
...
$_SERVER['HTTP_HOST'] = 'jacksonvillesod.com';
...
$source = trim($_POST['source'] ?? 'jacksonvillesod.com');
...
<head>
    ...
    <title>Thank You | Land Impressions</title>
    <style>
