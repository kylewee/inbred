...
$source = trim($_POST['source'] ?? 'sodjax.com');
...
<head>
    ...
    <title>Thank You | We Sod Jax</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        h1 { color: #16a34a; margin-bottom: 15px; }
        ...
        .phone a { color: #16a34a; text-decoration: none; }
        .btn {
